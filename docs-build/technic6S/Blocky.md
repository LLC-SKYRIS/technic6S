...
Для того, чтобы открыть интерфейс блочного программирования в Tehcnic, [подключитесь к Technic по Wi-Fi](wifi.md) и перейдите на страницу http://10.42.0.1:8000/technic_blocks/ либо нажмите ссылку *Blocks programming* на [основной веб-странице Technic](WebInterface.md).
