...
Для запуска визуализация состояния Техника в реальном времени, необходимо подключиться к нему по [Wi-Fi](ConnectingToWi-Fi.md) (`technic-xxxx`) и запустить rviz, указав соответствующий ROS_MASTER_URI:
