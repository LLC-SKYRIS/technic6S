...
Пункт View Image Topics (web_video_server) позволяет увидеть [просмотр изображений с камер](CameraImages.md), детекцию аруко меток, а также детекцию объектов используя нейронные сети. 
