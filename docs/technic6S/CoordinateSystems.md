...
При использовании [визуальной навигации по ArUco-маркерам](ArucoMarker.md) добавляются дополнительные фреймы:

- **`aruco_map`** — система координат, соответствующая [карте маркеров](ArucoMap.md);
    
- **`aruco_N`** — координаты, связанные с конкретным [маркером](Aruco.md), где _N_ — его ID.
    

>  **Подсказка:** согласно [стандарту REP-103](http://www.ros.org/reps/rep-0103.html), для фреймов, связанных с дроном, оси направлены следующим образом: X — вперёд, Y — влево, Z — вверх.
