...
> ℹ️ Функция `navigate` выполняется асинхронно: скрипт продолжает работу, не дожидаясь достижения точки. Для блокирующей версии используйте [`navigate_wait`](snippets.md#navigate_wait).
...
> **Hint** В Technic также доступен режим [блочного программирования](Blocky.md), позволяющий создавать сценарии без кода.
