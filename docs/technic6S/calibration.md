...
Убедитесь что файл калибровки камеры, который лежит в проекте Техника соответствует вашей камере. В данный момент в проекте лежит калибровка для модели AR0234
