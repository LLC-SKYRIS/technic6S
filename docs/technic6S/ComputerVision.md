...
Если изображение с камеры отсутствует, попробуйте проверить ее с помощью утилиты [`orangepicheckcamera`]().
...
Получите картинку с камеры утилитой `orangepicheckcamera`:

```bash
orangepicheckcamera -o test.jpg
```
