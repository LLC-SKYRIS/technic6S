...
> **Hint** Для высокоскоростного распознавания и позиционирования лучше использовать [ArUco-маркеры](Программирование/Периферия/Сенсорная_периферия/ArucoMarker.md).
