...
Для корректной работы всех функций, связанных с компьютерным зрением (в том числе [полета по ArUco-маркерам](Программирование/Периферия/Сенсорная_периферия/Aruco.md) и [Optical Flow](Программирование/Периферия/Сенсорная_периферия/OpticalFlow.md)) необходимо сфокусировать основную камеру, а также выставить ее расположение и ориентацию. Улучшить качество работы также может опциональная калибровка камеры.
