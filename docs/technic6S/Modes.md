...
* **OFFBOARD** — управление полетом с [OrangePi 5 Pro](OrangePi.md). Этот режим используется в Технике для [программирования автономных полетов](AutonomousFlightOffboard.md).
