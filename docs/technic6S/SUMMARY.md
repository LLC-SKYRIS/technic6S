...
* [Программирование](Programming.md)
	...
	* [MAVROS](MAVROS.md)
	* [Компьютерное зрение](ComputerVision.md)
	* [Нейронные сети (CNN)](CNN.md)
...
* [Периферия](Программирование/Периферия/Периферия.md)
    * Сенсорная периферия
        ...
        * [Визуальные маркеры](Программирование/Периферия/Сенсорная_периферия/Aruco.md)
	        * [Распознавание ArUco-маркеров](Программирование/Периферия/Сенсорная_периферия/ArucoMarker.md)
	        * [Навигация по картам ArUco-маркеров](Программирование/Периферия/Сенсорная_периферия/ArucoMap.md)
        * [Лазерный дальномер](Программирование/Периферия/Сенсорная_периферия/LaserRangefinder.md)
        * [Ультразвуковой дальномер](Программирование/Периферия/Сенсорная_периферия/UltrasonicRangefinder.md)
    * Исполнительная периферия
        * [GPIO](Программирование/Периферия/Исполнительная_периферия/GPIO.md)
        * [Светодиодная лента](Программирование/Периферия/Исполнительная_периферия/LedStrip.md)
---
