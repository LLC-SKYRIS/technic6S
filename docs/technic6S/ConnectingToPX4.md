...
Для программирования [автономных полетов](AutonomousFlight.md), [работы с Pixhawk (Pixracer) по Wi-Fi](ConnectingToPX4.md), использования [телефонного пульта](rc.md) и других функций необходимо соединение OPi и полетного контроллера.
