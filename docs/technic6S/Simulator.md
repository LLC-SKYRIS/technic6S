...
Дополнительно предоставляется [образ виртуальной машины](SimulationVm.md), содержащий предварительно настроенное окружение, повторяющее программную конфигурацию реального дрона.
