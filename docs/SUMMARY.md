...
* [Техник 6S](technic6S/README.md)
	...
	* Программирование
	    ...
	    * [Автономный полет](technic6S/AutonomousFlight.md)
	    * [Режим автономного полета (OFFBOARD)](technic6S/AutonomousFlightOffboard.md)
	    * [Блочное программирование](technic6S/Blocky.md)
	    * [Просмотр изображений с камер](technic6S/CameraImages.md)
	    * [ROS топики в Веб Интерфейсе](technic6S/ROSWeb.md)
	    * [ROS](technic6S/ROS.md)
	    * [MAVROS](technic6S/MAVROS.md)
	    * [Компьютерное зрение](technic6S/ComputerVision.md)
	    * [Нейронные сети (CNN)](technic6S/CNN.md)
	    * [Интеграция нейронных сетей в Technic6S](technic6S/IntergrationCNN.md)

	* Периферия
		* [Периферия](technic6S/Периферия.md)
	    * [Optical flow](technic6S/OpticalFlow.md)
	    * [Визуальные маркеры](technic6S/Aruco.md)
	    * [Распознавание ArUco-маркеров](technic6S/ArucoMarker.md)
	...
	* Доп материалы
	    ...
	    * [Запись экрана с дрона](CameraScreen.md)
...
* [Пилот FPV](pilotFPV/README.md)
	...
	* Настройка
	    ...
	    * [Настройка PID и Настройка OSD](pilotFPV/Настройка5.md)
	    * [Настройка рабочих частот и Настройка LED-модулей](pilotFPV/Настройка6.md)
	    * [Шаг 3: Первичная настройка приемника и Настройка пульта](pilotFPV/Настройка7.md)
	    * [Настройка приемника в BetaFlight](pilotFPV/Настройка8.md)


---

* [Стенд ВМГ](stand-vmg/README.md)
	* [Управление испытанием](stand-vmg/Управление_испытанием.md)
	* [Общие элементы интерфейса](stand-vmg/Общие_элементы_интерфейса.md)
	* [Страница Управление тестом](stand-vmg/Страница_управление_тестом.md)
	* [Страница Результаты](stand-vmg/Страница_результаты.md)
	* [Страница Настройки](stand-vmg/Страница_настройки.md)
	* [Рекомендуемый порядок испытаний](stand-vmg/Рекомендуемый_порядок_испытаний.md)
	* [Действия при нештатной ситуации](stand-vmg/Действия_при_нештатной_ситуации.md)